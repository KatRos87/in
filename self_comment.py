...
path_replay_btn = path_post + \
    "div[1]/ul/ul[1]/div/li/div/div[1]/div[2]/div/div/button"
...
for c in tags[:-1]:
    browser.find_element_by_xpath(
        xpath=path_replay_comment + "textarea").send_keys(c + " ")
    time.sleep(.5)
time.sleep(1)
browser.find_element_by_xpath(
    xpath=path_replay_comment + "textarea").send_keys(tags[-1])
time.sleep(10)
# input("*****")
